...
import { Send, Mic, MicOff, Bot, User, Lightbulb, TrendingUp, Package, DollarSign } from 'lucide-react';
...
const AIAssistant = () => {
  ...
  const quickActions = [
    {
      ...
      query: 'What are today\'s sales metrics and how do they compare to yesterday?'
    },
    {
      icon: Package,
    ...
    },
    {
      ...
      query: 'Analyze our revenue trends for the past week and provide insights'
    },
    {
      icon: Lightbulb,
      title: 'Product Recommendations',
      description: 'Get AI-powered suggestions',
      query: 'What products should I promote this week based on current trends?'
    }
  ];
  ...
  useEffect(() => {
    ...
    if (messages.length === 0) {
      setMessages([{
        id: 1,
        content: "Hello! I'm your AI retail assistant. I can help you with sales analytics, inventory management, customer insights, and business recommendations. How can I assist you today?",
        sender: 'ai',
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <div className="flex-1 max-w-4xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Your intelligent retail companion powered by advanced AI</p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Performance metrics, trends, and forecasting</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Stock levels, reorder alerts, and optimization</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Dynamic pricing and profit optimization</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Behavior analysis and segmentation</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Product suggestions and business strategies</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Generate insights and summaries instantly</p>
              </div>
            </div>
          </div>
        </div>
