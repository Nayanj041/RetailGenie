        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-600">
              Monitor your business performance with AI-powered insights
            </p>
          </div>
          <select
            value={timeRange}
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="flex items-center mt-2">
                  ...
                  <span
                    className={`ml-1 text-sm ${getTrendColor(overview.revenue_change)}`}
                  >
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="flex items-center mt-2">
                  ...
                  <span
                    className={`ml-1 text-sm ${getTrendColor(overview.orders_change)}`}
                  >
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="flex items-center mt-2">
                  ...
                  <span
                    className={`ml-1 text-sm ${getTrendColor(overview.customers_change)}`}
                  >
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="flex items-center mt-2">
                  ...
                  <span
                    className={`ml-1 text-sm ${getTrendColor(overview.conversion_change)}`}
                  >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="p-4 bg-blue-50 rounded-lg">
              ...
              <p className="text-sm text-blue-700">
                Revenue is trending upward with a{" "}
                {formatPercentage(overview.revenue_change)} increase. Peak sales
                occur on weekends.
              </p>
            </div>
            <div className="p-4 bg-green-50 rounded-lg">
              ...
              <p className="text-sm text-green-700">
                Electronics category shows strongest growth. Consider expanding
                this category's inventory.
              </p>
            </div>
            <div className="p-4 bg-purple-50 rounded-lg">
              ...
              <p className="text-sm text-purple-700">
                ...
                {formatCurrency(customer_segments[0]?.avg_order_value)} average
                order value. Focus retention strategies here.
              </p>
            </div>
          </div>
        </div>
