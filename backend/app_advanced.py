    ...
    def list_all_routes():
        ...
        routes = {
            "authentication": [
                ...
                {"endpoint": "/api/v1/auth/profile", "method": "GET", "description": "Get user profile"},
                {"endpoint": "/api/v1/auth/refresh", "method": "POST", "description": "Refresh JWT token"}
            ],
            "products": [
                {"endpoint": "/api/v1/products", "method": "GET", "description": "Get all products"},
                ...
                {"endpoint": "/api/v1/products/search", "method": "GET", "description": "Search products"},
            ...
            "analytics": [
                {"endpoint": "/api/v1/analytics/dashboard", "method": "GET", "description": "Get dashboard analytics"},
                {"endpoint": "/api/v1/analytics/sales", "method": "GET", "description": "Get sales analytics"},
                {"endpoint": "/api/v1/analytics/products", "method": "GET", "description": "Get product analytics"},
                {"endpoint": "/api/v1/analytics/customers", "method": "GET", "description": "Get customer analytics"}
            ],
            "ai_assistant": [
            ...
            "pricing": [
                {"endpoint": "/api/v1/pricing/products/<id>", "method": "GET", "description": "Get product pricing"},
                {"endpoint": "/api/v1/pricing/discounts", "method": "POST", "description": "Apply discounts"},
                {"endpoint": "/api/v1/pricing/analytics", "method": "GET", "description": "Get pricing analytics"}
            ],
            "system": [
                {"endpoint": "/api/v1/health", "method": "GET", "description": "System health check"},
                {"endpoint": "/api/v1/routes", "method": "GET", "description": "List all routes"},
                {"endpoint": "/api/v1/database/init", "method": "POST", "description": "Initialize database"}
            ]
        }
