...
def create_error_response(message, status_code, path):
    ...
    return jsonify(
        {
            "success": False,
            "error": {"message": message, "status_code": status_code, "path": path},
        }
    )
...
def get_sentiment_analysis():
    ...
    try:
                ...
                "trending_topics": [
                    {
                        ...
                        "sentiment": "positive",
                        "mentions": batch_results["statistics"]["positive_count"],
                    },
                    {
                        "topic": "customer service",
                        "sentiment": "neutral",
                        "mentions": batch_results["statistics"]["neutral_count"],
                    },
                    {
                        "topic": "delivery",
                        "sentiment": "negative",
                        "mentions": batch_results["statistics"]["negative_count"],
                    },
                ],
        ...
        return (
            create_error_response("Failed to analyze sentiment", 500, request.path),
            500,
        )
    ...
    try:
        ...
        return (
            create_error_response(
                "Failed to generate inventory forecast", 500, request.path
            ),
            500,
        )
