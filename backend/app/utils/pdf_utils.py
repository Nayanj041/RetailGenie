...
class PDFUtils:
    ...
    def generate_feedback_report(
        ...
        try:
            ...
            report_content = self._generate_feedback_report_content(
                product_id, feedback_data, analysis
            )
    ...
    def _generate_feedback_report_content(
        self,
        product_id: str,
        feedback_data: List[Dict[str, Any]],
        analysis: Dict[str, Any],
...
"""
        ...
        for i, feedback in enumerate(
            feedback_data[:10], 1
        ):  # Limit to 10 entries for brevity
            content += f"""
