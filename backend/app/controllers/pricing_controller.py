...
class PricingController:
    ...
    def apply_discount(self, product_id: str, discount_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            discount = {
                ...
                "start_date": discount_data.get("start_date", datetime.now().isoformat()),
            ...
            logger.info(f"Discount applied to product {product_id}: {discount['percentage']}%")
        ...
        try:
            ...
            for update in updates:
                ...
                try:
                    ...
                    self.firebase.update_document("products", product_id, {"price": new_price})
            ...
            logger.info(f"Bulk pricing update completed: {len(updated_products)} products updated")
    ...
    def _get_active_discounts(self, product_id: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            for discount in discounts:
                start_date = datetime.fromisoformat(discount.get("start_date", now.isoformat()))
